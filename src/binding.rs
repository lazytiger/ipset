...
pub const IPSET_CIDR_SEPARATOR: &[u8; 2usize] = b"/\0";
pub const IPSET_RANGE_SEPARATOR: &[u8; 2usize] = b"-\0";
pub const IPSET_ELEM_SEPARATOR: &[u8; 2usize] = b",\0";
pub const IPSET_NAME_SEPARATOR: &[u8; 2usize] = b",\0";
pub const IPSET_PROTO_SEPARATOR: &[u8; 2usize] = b":\0";
pub const IPSET_ESCAPE_START: &[u8; 2usize] = b"[\0";
pub const IPSET_ESCAPE_END: &[u8; 2usize] = b"]\0";
